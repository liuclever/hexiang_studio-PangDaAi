...
public class NoticeManagementTools {
    ...
    public String confirmNoticeDeletion(
        ...
        try {
            ...
            log.info(" 开始删除公告 '{}', 共找到 {} 个同标题公告", title, totalNotices);
            
            // 处理每个公告及其附件和图片
            for (Map<String, Object> notice : notices) {
                Long noticeId = (Long) notice.get("noticeId");
                log.debug("🗂 处理公告 ID: {}, 标题: {}", noticeId, notice.get("title"));
                ...
                log.debug(" 删除图片记录: {} 条", imageRecords);
            }
