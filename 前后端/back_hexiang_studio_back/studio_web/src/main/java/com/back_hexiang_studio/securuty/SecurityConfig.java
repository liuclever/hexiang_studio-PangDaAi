    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/wxUser/login").permitAll()    // 微信用户登录接口（旧版兼容）
                        .requestMatchers("/wx/user/login").permitAll()   // 微信用户登录接口（新版）
                        ...
                        .requestMatchers("/api/ai/rag/**").permitAll()  // RAG管理接口放行
                        ...
                        .requestMatchers("/wxUser/**").authenticated()    // 微信用户接口需要认证（旧版兼容）
                        .requestMatchers("/wx/**").authenticated()        // 微信端接口需要认证（新版）
